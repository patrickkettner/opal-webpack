...
// TODO: might want to move this to its own file as well
// spend some time looking at the exact convention of 'file' as it goes into here
...
// TODO: Own file, call it getWebpackRequire(options, relativePath, absolutePath)
// filename => relativePath, resolved => absolutePath
// prepend can be dealt with by calling code
...
// TODO: own file, call getOpalStub(relativePath)
// don't need options for stubs
// prepend can be dealt with by calling code
  ...
  const addRequires = files => {
    files.forEach(filename => {
      ...
      if (resolved && resolved.match(/\.js$/)) {
        // TODO: Move this to a getJsRequire function
