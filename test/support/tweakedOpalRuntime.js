...
Opal.modules["corelib/helpers"] = function(Opal) {
  ...
  return (function($base) {
    ...
    Opal.defs(self, '$const_name!', TMP_12 = function(const_name) {
      ...
      if ((($a = const_name['$[]'](0)['$!='](const_name['$[]'](0).$upcase())) !== nil && (!$a.$$is_boolean || $a == true))) {
...
Opal.modules["corelib/module"] = function(Opal) {
  ...
  Opal.add_stubs(['$===', '$raise', '$equal?', '$<', '$>', '$nil?', '$attr_reader', '$attr_writer', '$coerce_to!', '$new', '$const_name!', '$=~', '$inject', '$const_get', '$split', '$const_missing', '$==', '$!', '$start_with?', '$to_proc', '$lambda', '$bind', '$call', '$class', '$append_features', '$included', '$name', '$to_s', '$__id__', '$constants', '$include?']);
  return (function($base, $super) {
    ...
    Opal.defn(self, '$const_defined?', TMP_20 = function(name, inherit) {
      ...
      if ((($a = name['$=~']((($scope.get('Opal')).$$scope.get('CONST_NAME_REGEXP')))) !== nil && (!$a.$$is_boolean || $a == true))) {
        } else {
...
if (o == null) o = nil;if (c == null) c = nil;
    ...
    Opal.defn(self, '$const_set', TMP_24 = function ːconst_set(name, value) {
      ...
      name = $scope.get('Opal')['$const_name!'](name);
      if ((($a = ((($b = (name['$=~']((($scope.get('Opal')).$$scope.get('CONST_NAME_REGEXP'))))['$!']()) !== false && $b !== nil) ? $b : name['$start_with?']("::"))) !== nil && (!$a.$$is_boolean || $a == true))) {
        self.$raise($scope.get('NameError').$new("wrong constant name " + (name), name))};
    ...
    Opal.defn(self, '$define_method', TMP_25 = function ːdefine_method(name, method) {
      ...
      ((($a = block) !== false && $a !== nil) ? $a : block = (function() {$case = method;if ($scope.get('Proc')['$===']($case)) {return method}else if ($scope.get('Method')['$===']($case)) {return method.$to_proc().$$unbound;}else if ($scope.get('UnboundMethod')['$===']($case)) {return ($b = ($c = self).$lambda, $b.$$p = (TMP_26 = function($d_rest){var self = TMP_26.$$s || this, args, $e, bound = nil;
    ...
    Opal.defn(self, '$module_eval', TMP_39 = function ːmodule_eval() {
    ...
    Opal.defn(self, '$module_exec', TMP_40 = function ːmodule_exec($a_rest) {
      var self = this, args, $iter = TMP_40.$$p, block = $iter || nil;
    ...
    Opal.defn(self, '$method_defined?', TMP_41 = function(method) {
      var self = this;
    ...
    Opal.defn(self, '$module_function', TMP_42 = function ːmodule_function($a_rest) {
    ...
    Opal.defn(self, '$name', TMP_43 = function ːname() {
      var self = this;
    ...
    Opal.defn(self, '$remove_class_variable', TMP_44 = function ːremove_class_variable($a_rest) {
      var self = this;

      return nil;
    }, TMP_44.$$arity = -1);

    Opal.defn(self, '$remove_const', TMP_45 = function ːremove_const(name) {
      var self = this;
    ...
    Opal.defn(self, '$to_s', TMP_46 = function ːto_s() {
      var $a, self = this;

      return ((($a = Opal.Module.$name.call(self)) !== false && $a !== nil) ? $a : "#<" + (self.$$is_module ? 'Module' : 'Class') + ":0x" + (self.$__id__().$to_s(16)) + ">");
    }, TMP_46.$$arity = 0);

    Opal.defn(self, '$undef_method', TMP_47 = function ːundef_method($a_rest) {
      var self = this, names;
    ...
    return (Opal.defn(self, '$instance_variables', TMP_48 = function ːinstance_variables() {
    ...
    }, TMP_48.$$arity = 0), nil) && 'instance_variables';
  })($scope.base, null)
};
...
Opal.modules["corelib/class"] = function(Opal) {
  ...
  Opal.add_stubs(['$require', '$allocate']);
  ...
  return (function($base, $super) {
    ...
    return (Opal.defn(self, '$superclass', TMP_5 = function ːsuperclass() {
      var self = this;

      return self.$$super || nil;
    }, TMP_5.$$arity = 0), nil) && 'superclass';
  })($scope.base, null);
};
...
Opal.modules["corelib/basic_object"] = function(Opal) {
  ...
  Opal.add_stubs(['$==', '$!', '$nil?', '$cover?', '$size', '$raise', '$merge', '$compile', '$lambda', '$>', '$new', '$inspect']);
  return (function($base, $super) {
    ...
    Opal.defn(self, '$instance_eval', TMP_8 = function ːinstance_eval($a_rest) {
      ...
      TMP_8.$$p = null;
      if ((($b = ($c = block['$nil?'](), $c !== false && $c !== nil ?!!Opal.compile : $c)) !== nil && (!$b.$$is_boolean || $b == true))) {
        if ((($b = ($range(1, 3, false))['$cover?'](args.$size())) !== nil && (!$b.$$is_boolean || $b == true))) {
          } else {
        ...
        default_eval_options = $hash2(["file", "eval"], {"file": (((($b = file) !== false && $b !== nil) ? $b : "(eval)")), "eval": true});
        compiling_options = Opal.hash({ arity_check: false }).$merge(default_eval_options);
        compiled = $scope.get('Opal').$compile(string, compiling_options);
        block = ($b = ($c = $scope.get('Kernel')).$lambda, $b.$$p = (TMP_9 = function(){var self = TMP_9.$$s || this;
      ...
      } else if ((($b = $rb_gt(args.$size(), 0)) !== nil && (!$b.$$is_boolean || $b == true))) {
    ...
    return (Opal.defn(self, '$method_missing', TMP_14 = function ːmethod_missing(symbol, $a_rest) {
      ...
      TMP_14.$$p = null;
      return $scope.get('Kernel').$raise($scope.get('NoMethodError').$new((function() {if ((($b = self.$inspect && !self.$inspect.$$stub) !== nil && (!$b.$$is_boolean || $b == true))) {
...
Opal.modules["corelib/kernel"] = function(Opal) {
  ...
  (function($base) {
    ...
    Opal.defn(self, '$exit', TMP_21 = function ːexit(status) {
      ...
      ((($a = $gvars.__at_exit__) !== false && $a !== nil) ? $a : $gvars.__at_exit__ = []);
      while ((($b = $rb_gt($gvars.__at_exit__.$size(), 0)) !== nil && (!$b.$$is_boolean || $b == true))) {
    ...
    Opal.defn(self, '$format', TMP_23 = function ːformat(format_string, $a_rest) {
      ...
      if ((($b = (($c = args.$length()['$=='](1)) ? args['$[]'](0)['$respond_to?']("to_ary") : args.$length()['$=='](1))) !== nil && (!$b.$$is_boolean || $b == true))) {
        ary = $scope.get('Opal')['$coerce_to?'](args['$[]'](0), $scope.get('Array'), "to_ary");
        if ((($b = ary['$nil?']()) !== nil && (!$b.$$is_boolean || $b == true))) {
          } else {
          args = ary.$to_a()
        };};
    ...
    Opal.defn(self, '$printf', TMP_41 = function ːprintf($a_rest) {
      ...
      if ((($b = $rb_gt(args.$length(), 0)) !== nil && (!$b.$$is_boolean || $b == true))) {
...
if (obj == null) obj = nil;
      ...
      if ((($b = $rb_le(args.$length(), 1)) !== nil && (!$b.$$is_boolean || $b == true))) {
        return args['$[]'](0)
        } else {
        return args
      };
    ...
    Opal.defn(self, '$warn', TMP_47 = function ːwarn($a_rest) {
      ...
      if ((($b = ((($c = $gvars.VERBOSE['$nil?']()) !== false && $c !== nil) ? $c : strs['$empty?']())) !== nil && (!$b.$$is_boolean || $b == true))) {
        return nil
        } else {
...
Opal.modules["corelib/constants"] = function(Opal) {
  ...
  Opal.cdecl($scope, 'RUBY_ENGINE_VERSION', "0.10.0.beta2.webpacktest");
  Opal.cdecl($scope, 'RUBY_RELEASE_DATE', "2015-12-20");
...
Opal.modules["corelib/string"] = function(Opal) {
  ...
  (function($base, $super) {
    ...
    Opal.defn(self, '$to_proc', TMP_61 = function ːto_proc() {
      ...
      sym = self;
      return ($a = ($b = self).$proc, $a.$$p = (TMP_60 = function($c_rest){var self = TMP_60.$$s || this, args, block, $d, $e, obj = nil;
      ...
      if ((($d = args['$empty?']()) !== nil && (!$d.$$is_boolean || $d == true))) {
...
Opal.modules["corelib/enumerable"] = function(Opal) {
  ...
  Opal.add_stubs(['$each', '$destructure', '$raise', '$new', '$yield', '$dup', '$enum_for', '$enumerator_size', '$flatten', '$map', '$==', '$respond_to?', '$coerce_to!', '$>', '$*', '$nil?', '$coerce_to', '$try_convert', '$<', '$+', '$-', '$to_enum', '$ceil', '$/', '$size', '$===', '$<<', '$[]', '$[]=', '$inspect', '$__send__', '$<=>', '$first', '$reverse', '$sort', '$to_proc', '$compare', '$proc', '$call', '$to_a', '$lambda', '$sort!', '$map!', '$zip']);
  return (function($base) {
    var $Enumerable, self = $Enumerable = $module($base, 'Enumerable');

    var def = self.$$proto, $scope = self.$$scope, TMP_1, TMP_4, TMP_7, TMP_10, TMP_12, TMP_15, TMP_16, TMP_18, TMP_20, TMP_21, TMP_22, TMP_24, TMP_26, TMP_28, TMP_30, TMP_32, TMP_33, TMP_35, TMP_40, TMP_41, TMP_42, TMP_45, TMP_46, TMP_48, TMP_49, TMP_50, TMP_51, TMP_53, TMP_54, TMP_56, TMP_58, TMP_59, TMP_62, TMP_65, TMP_67, TMP_69, TMP_71, TMP_73, TMP_75, TMP_80, TMP_81, TMP_83;

    Opal.defn(self, '$all?', TMP_1 = function() {
      var $a, $b, TMP_2, $c, TMP_3, self = this, $iter = TMP_1.$$p, block = $iter || nil, result = nil;

      TMP_1.$$p = null;
      result = true;
      if ((block !== nil)) {
        (function(){var $brk = Opal.new_brk(); try {return ($a = ($b = self).$each, $a.$$p = (TMP_2 = function($c_rest){var self = TMP_2.$$s || this, value, $d;
        ...
        if ((($d = Opal.yieldX(block, Opal.to_a(value))) !== nil && (!$d.$$is_boolean || $d == true))) {
            return nil
            } else {
            result = false;

            Opal.brk(nil, $brk);
          }}, TMP_2.$$s = self, TMP_2.$$brk = $brk, TMP_2.$$arity = -1, TMP_2), $a).call($b)
        } catch (err) { if (err === $brk) { return err.$v } else { throw err } }})()
        } else {
        (function(){var $brk = Opal.new_brk(); try {return ($a = ($c = self).$each, $a.$$p = (TMP_3 = function($d_rest){var self = TMP_3.$$s || this, value, $e;
        ...
        if ((($e = $scope.get('Opal').$destructure(value)) !== nil && (!$e.$$is_boolean || $e == true))) {
            return nil
            } else {
            result = false;

            Opal.brk(nil, $brk);
          }}, TMP_3.$$s = self, TMP_3.$$brk = $brk, TMP_3.$$arity = -1, TMP_3), $a).call($c)
        } catch (err) { if (err === $brk) { return err.$v } else { throw err } }})()
      };
      return result;
    }, TMP_1.$$arity = 0);

    Opal.defn(self, '$any?', TMP_4 = function() {
      var $a, $b, TMP_5, $c, TMP_6, self = this, $iter = TMP_4.$$p, block = $iter || nil, result = nil;

      TMP_4.$$p = null;
      result = false;
      if ((block !== nil)) {
        (function(){var $brk = Opal.new_brk(); try {return ($a = ($b = self).$each, $a.$$p = (TMP_5 = function($c_rest){var self = TMP_5.$$s || this, value, $d;
        ...
        if ((($d = Opal.yieldX(block, Opal.to_a(value))) !== nil && (!$d.$$is_boolean || $d == true))) {
            ...
            return nil
          }}, TMP_5.$$s = self, TMP_5.$$brk = $brk, TMP_5.$$arity = -1, TMP_5), $a).call($b)
        } catch (err) { if (err === $brk) { return err.$v } else { throw err } }})()
        } else {
        (function(){var $brk = Opal.new_brk(); try {return ($a = ($c = self).$each, $a.$$p = (TMP_6 = function($d_rest){var self = TMP_6.$$s || this, value, $e;
        ...
        if ((($e = $scope.get('Opal').$destructure(value)) !== nil && (!$e.$$is_boolean || $e == true))) {
            ...
            return nil
          }}, TMP_6.$$s = self, TMP_6.$$brk = $brk, TMP_6.$$arity = -1, TMP_6), $a).call($c)
        } catch (err) { if (err === $brk) { return err.$v } else { throw err } }})()
      };
      return result;
    }, TMP_4.$$arity = 0);
...
if (item == null) item = nil;
    ...
    Opal.defn(self, '$cycle', TMP_16 = function ːcycle(n) {
      ...
      if ((block !== nil)) {
        ...
        return ($a = ($b = self).$enum_for, $a.$$p = (TMP_17 = function(){var self = TMP_17.$$s || this, $c;

        if (n['$=='](nil)) {
            if ((($c = self['$respond_to?']("size")) !== nil && (!$c.$$is_boolean || $c == true))) {
            ...
            n = $scope.get('Opal')['$coerce_to!'](n, $scope.get('Integer'), "to_int");
            if ((($c = $rb_gt(n, 0)) !== nil && (!$c.$$is_boolean || $c == true))) {
              return $rb_times(self.$enumerator_size(), n)
              } else {
              return 0
            };
          }}, TMP_17.$$s = self, TMP_17.$$arity = 0, TMP_17), $a).call($b, "cycle", n)
      };
      if ((($a = n['$nil?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
        } else {
        n = $scope.get('Opal')['$coerce_to!'](n, $scope.get('Integer'), "to_int");
    ...
    Opal.defn(self, '$detect', TMP_18 = function ːdetect(ifnone) {
      var $a, $b, TMP_19, self = this, $iter = TMP_18.$$p, block = $iter || nil, result = nil;
      ...
      result = undefined;
      (function(){var $brk = Opal.new_brk(); try {return ($a = ($b = self).$each, $a.$$p = (TMP_19 = function($c_rest){var self = TMP_19.$$s || this, args, $d, value = nil;
      ...
      value = $scope.get('Opal').$destructure(args);
        if ((($d = Opal.yield1(block, value)) !== nil && (!$d.$$is_boolean || $d == true))) {
          result = value;

          Opal.brk(nil, $brk);
          } else {
          return nil
        };}, TMP_19.$$s = self, TMP_19.$$brk = $brk, TMP_19.$$arity = -1, TMP_19), $a).call($b)
      } catch (err) { if (err === $brk) { return err.$v } else { throw err } }})();
    ...
    Opal.defn(self, '$drop', TMP_20 = function ːdrop(number) {
      var $a, self = this;
    ...
    Opal.defn(self, '$drop_while', TMP_21 = function ːdrop_while() {
    ...
    Opal.defn(self, '$each_cons', TMP_22 = function ːeach_cons(n) {
      ...
      if ((block !== nil)) {
        ...
        return ($a = ($b = self).$enum_for, $a.$$p = (TMP_23 = function(){var self = TMP_23.$$s || this, $c, $d, enum_size = nil;

        enum_size = self.$enumerator_size();
          if ((($c = enum_size['$nil?']()) !== nil && (!$c.$$is_boolean || $c == true))) {
            return nil
          } else if ((($c = ((($d = enum_size['$=='](0)) !== false && $d !== nil) ? $d : $rb_lt(enum_size, n))) !== nil && (!$c.$$is_boolean || $c == true))) {
            return 0
            } else {
            return $rb_plus($rb_minus(enum_size, n), 1)
          };}, TMP_23.$$s = self, TMP_23.$$arity = 0, TMP_23), $a).call($b, "each_cons", n)
      };
    ...
    Opal.defn(self, '$each_entry', TMP_24 = function ːeach_entry($a_rest) {
      var $b, $c, TMP_25, self = this, data, $iter = TMP_24.$$p, block = $iter || nil;
      ...
      if ((block !== nil)) {
        ...
        return ($b = ($c = self).$to_enum, $b.$$p = (TMP_25 = function(){var self = TMP_25.$$s || this;

        return self.$enumerator_size()}, TMP_25.$$s = self, TMP_25.$$arity = 0, TMP_25), $b).apply($c, ["each_entry"].concat(Opal.to_a(data)))
      };
    ...
    Opal.defn(self, '$each_slice', TMP_26 = function ːeach_slice(n) {
      ...
      if ((block !== nil)) {
        ...
        return ($a = ($b = self).$enum_for, $a.$$p = (TMP_27 = function(){var self = TMP_27.$$s || this, $c;

        if ((($c = self['$respond_to?']("size")) !== nil && (!$c.$$is_boolean || $c == true))) {
            return ($rb_divide(self.$size(), n)).$ceil()
            } else {
            return nil
          }}, TMP_27.$$s = self, TMP_27.$$arity = 0, TMP_27), $a).call($b, "each_slice", n)
      };
    ...
    Opal.defn(self, '$each_with_index', TMP_28 = function ːeach_with_index($a_rest) {
      var $b, $c, TMP_29, self = this, args, $iter = TMP_28.$$p, block = $iter || nil;
      ...
      if ((block !== nil)) {
        ...
        return ($b = ($c = self).$enum_for, $b.$$p = (TMP_29 = function(){var self = TMP_29.$$s || this;

        return self.$enumerator_size()}, TMP_29.$$s = self, TMP_29.$$arity = 0, TMP_29), $b).apply($c, ["each_with_index"].concat(Opal.to_a(args)))
      };
    ...
    Opal.defn(self, '$each_with_object', TMP_30 = function ːeach_with_object(object) {
      var $a, $b, TMP_31, self = this, $iter = TMP_30.$$p, block = $iter || nil;

      TMP_30.$$p = null;
      if ((block !== nil)) {
        } else {
        return ($a = ($b = self).$enum_for, $a.$$p = (TMP_31 = function(){var self = TMP_31.$$s || this;

        return self.$enumerator_size()}, TMP_31.$$s = self, TMP_31.$$arity = 0, TMP_31), $a).call($b, "each_with_object", object)
      };
    ...
    Opal.defn(self, '$entries', TMP_32 = function ːentries($a_rest) {
      var self = this, args;
    ...
    Opal.defn(self, '$find_all', TMP_33 = function ːfind_all() {
      ...
      if ((block !== nil)) {
        ...
        return self.$enumerator_size()}, TMP_34.$$s = self, TMP_34.$$arity = 0, TMP_34), $a).call($b, "find_all")
      };
    ...
    Opal.defn(self, '$find_index', TMP_35 = function ːfind_index(object) {
      var $a, $b, TMP_36, $c, TMP_37, self = this, $iter = TMP_35.$$p, block = $iter || nil, result = nil, index = nil;
      ...
      index = 0;
      if ((($a = object != null) !== nil && (!$a.$$is_boolean || $a == true))) {
        (function(){var $brk = Opal.new_brk(); try {return ($a = ($b = self).$each, $a.$$p = (TMP_36 = function($c_rest){var self = TMP_36.$$s || this, value;
        ...
        if ($scope.get('Opal').$destructure(value)['$=='](object)) {
            ...
            Opal.brk(nil, $brk);};
          return index += 1;}, TMP_36.$$s = self, TMP_36.$$brk = $brk, TMP_36.$$arity = -1, TMP_36), $a).call($b)
        } catch (err) { if (err === $brk) { return err.$v } else { throw err } }})()
        } else {
        (function(){var $brk = Opal.new_brk(); try {return ($a = ($c = self).$each, $a.$$p = (TMP_37 = function($d_rest){var self = TMP_37.$$s || this, value, $e;
        ...
        if ((($e = Opal.yieldX(block, Opal.to_a(value))) !== nil && (!$e.$$is_boolean || $e == true))) {
            result = index;

            Opal.brk(nil, $brk);};
          return index += 1;}, TMP_37.$$s = self, TMP_37.$$brk = $brk, TMP_37.$$arity = -1, TMP_37), $a).call($c)
        } catch (err) { if (err === $brk) { return err.$v } else { throw err } }})()
      };
      return result;
    }, TMP_35.$$arity = -1);

    Opal.defn(self, '$first', TMP_40 = function ːfirst(number) {
      var $a, $b, TMP_38, $c, TMP_39, self = this, result = nil, current = nil;

      if ((($a = number === undefined) !== nil && (!$a.$$is_boolean || $a == true))) {
        result = nil;
        (function(){var $brk = Opal.new_brk(); try {return ($a = ($b = self).$each, $a.$$p = (TMP_38 = function(value){var self = TMP_38.$$s || this;
if (value == null) value = nil;
        result = value;

          Opal.brk(nil, $brk);}, TMP_38.$$s = self, TMP_38.$$brk = $brk, TMP_38.$$arity = 1, TMP_38), $a).call($b)
        } catch (err) { if (err === $brk) { return err.$v } else { throw err } }})();
        } else {
        result = [];
        number = $scope.get('Opal').$coerce_to(number, $scope.get('Integer'), "to_int");
        ...
        if ((($a = number == 0) !== nil && (!$a.$$is_boolean || $a == true))) {
          return []};
        current = 0;
        (function(){var $brk = Opal.new_brk(); try {return ($a = ($c = self).$each, $a.$$p = (TMP_39 = function($d_rest){var self = TMP_39.$$s || this, args, $e;
        ...
        result.push($scope.get('Opal').$destructure(args));
          if ((($e = number <= ++current) !== nil && (!$e.$$is_boolean || $e == true))) {

            Opal.brk(nil, $brk)
            } else {
            return nil
          };}, TMP_39.$$s = self, TMP_39.$$brk = $brk, TMP_39.$$arity = -1, TMP_39), $a).call($c)
        } catch (err) { if (err === $brk) { return err.$v } else { throw err } }})();
      };
      return result;
    }, TMP_40.$$arity = -1);
    ...
    Opal.defn(self, '$grep', TMP_41 = function ːgrep(pattern) {
    ...
    Opal.defn(self, '$group_by', TMP_42 = function ːgroup_by() {
      var $a, $b, TMP_43, $c, $d, self = this, $iter = TMP_42.$$p, block = $iter || nil, hash = nil;
      ...
      if ((block !== nil)) {
        ...
        return self.$enumerator_size()}, TMP_43.$$s = self, TMP_43.$$arity = 0, TMP_43), $a).call($b, "group_by")
      };
    ...
    Opal.defn(self, '$include?', TMP_45 = function(obj) {
      var $a, $b, TMP_44, self = this, result = nil;

      result = false;
      (function(){var $brk = Opal.new_brk(); try {return ($a = ($b = self).$each, $a.$$p = (TMP_44 = function($c_rest){var self = TMP_44.$$s || this, args;
      ...
      if ($scope.get('Opal').$destructure(args)['$=='](obj)) {
          ...
          return nil
        }}, TMP_44.$$s = self, TMP_44.$$brk = $brk, TMP_44.$$arity = -1, TMP_44), $a).call($b)
      } catch (err) { if (err === $brk) { return err.$v } else { throw err } }})();
      return result;
    }, TMP_45.$$arity = 1);

    Opal.defn(self, '$inject', TMP_46 = function ːinject(object, sym) {
      var self = this, $iter = TMP_46.$$p, block = $iter || nil;
    ...
    Opal.defn(self, '$lazy', TMP_48 = function ːlazy() {
      var $a, $b, TMP_47, self = this;

      return ($a = ($b = (($scope.get('Enumerator')).$$scope.get('Lazy'))).$new, $a.$$p = (TMP_47 = function(enum$, $c_rest){var self = TMP_47.$$s || this, args, $d;
      ...
      return ($d = enum$).$yield.apply($d, Opal.to_a(args))}, TMP_47.$$s = self, TMP_47.$$arity = -2, TMP_47), $a).call($b, self, self.$enumerator_size());
    }, TMP_48.$$arity = 0);

    Opal.defn(self, '$enumerator_size', TMP_49 = function ːenumerator_size() {
      var $a, self = this;
    ...
    Opal.defn(self, '$max', TMP_50 = function ːmax(n) {
      var $a, $b, self = this, $iter = TMP_50.$$p, block = $iter || nil;
    ...
    Opal.defn(self, '$max_by', TMP_51 = function ːmax_by() {
      var $a, $b, TMP_52, self = this, $iter = TMP_51.$$p, block = $iter || nil;

      TMP_51.$$p = null;
      if (block !== false && block !== nil) {
        } else {
        return ($a = ($b = self).$enum_for, $a.$$p = (TMP_52 = function(){var self = TMP_52.$$s || this;

        return self.$enumerator_size()}, TMP_52.$$s = self, TMP_52.$$arity = 0, TMP_52), $a).call($b, "max_by")
      };
    ...
    Opal.defn(self, '$min', TMP_53 = function ːmin() {
      var self = this, $iter = TMP_53.$$p, block = $iter || nil;
    ...
    Opal.defn(self, '$min_by', TMP_54 = function ːmin_by() {
      ...
      if (block !== false && block !== nil) {
        ...
        return self.$enumerator_size()}, TMP_55.$$s = self, TMP_55.$$arity = 0, TMP_55), $a).call($b, "min_by")
      };
    ...
    Opal.defn(self, '$minmax', TMP_56 = function ːminmax() {
      var $a, $b, $c, TMP_57, self = this, $iter = TMP_56.$$p, block = $iter || nil;

      TMP_56.$$p = null;
      ((($a = block) !== false && $a !== nil) ? $a : block = ($b = ($c = self).$proc, $b.$$p = (TMP_57 = function(a, b){var self = TMP_57.$$s || this;
if (a == null) a = nil;if (b == null) b = nil;
      return a['$<=>'](b)}, TMP_57.$$s = self, TMP_57.$$arity = 2, TMP_57), $b).call($c));
    ...
    Opal.defn(self, '$minmax_by', TMP_58 = function ːminmax_by() {
      var self = this, $iter = TMP_58.$$p, block = $iter || nil;
    ...
    Opal.defn(self, '$none?', TMP_59 = function() {
      var $a, $b, TMP_60, $c, TMP_61, self = this, $iter = TMP_59.$$p, block = $iter || nil, result = nil;

      TMP_59.$$p = null;
      result = true;
      if ((block !== nil)) {
        (function(){var $brk = Opal.new_brk(); try {return ($a = ($b = self).$each, $a.$$p = (TMP_60 = function($c_rest){var self = TMP_60.$$s || this, value, $d;
        ...
        if ((($d = Opal.yieldX(block, Opal.to_a(value))) !== nil && (!$d.$$is_boolean || $d == true))) {
            ...
            return nil
          }}, TMP_60.$$s = self, TMP_60.$$brk = $brk, TMP_60.$$arity = -1, TMP_60), $a).call($b)
        } catch (err) { if (err === $brk) { return err.$v } else { throw err } }})()
        } else {
        (function(){var $brk = Opal.new_brk(); try {return ($a = ($c = self).$each, $a.$$p = (TMP_61 = function($d_rest){var self = TMP_61.$$s || this, value, $e;
        ...
        if ((($e = $scope.get('Opal').$destructure(value)) !== nil && (!$e.$$is_boolean || $e == true))) {
            ...
            return nil
          }}, TMP_61.$$s = self, TMP_61.$$brk = $brk, TMP_61.$$arity = -1, TMP_61), $a).call($c)
        } catch (err) { if (err === $brk) { return err.$v } else { throw err } }})()
      };
      return result;
    }, TMP_59.$$arity = 0);

    Opal.defn(self, '$one?', TMP_62 = function() {
      var $a, $b, TMP_63, $c, TMP_64, self = this, $iter = TMP_62.$$p, block = $iter || nil, result = nil;

      TMP_62.$$p = null;
      result = false;
      if ((block !== nil)) {
        (function(){var $brk = Opal.new_brk(); try {return ($a = ($b = self).$each, $a.$$p = (TMP_63 = function($c_rest){var self = TMP_63.$$s || this, value, $d;
        ...
        if ((($d = Opal.yieldX(block, Opal.to_a(value))) !== nil && (!$d.$$is_boolean || $d == true))) {
            ...
            return nil
          }}, TMP_63.$$s = self, TMP_63.$$brk = $brk, TMP_63.$$arity = -1, TMP_63), $a).call($b)
        } catch (err) { if (err === $brk) { return err.$v } else { throw err } }})()
        } else {
        (function(){var $brk = Opal.new_brk(); try {return ($a = ($c = self).$each, $a.$$p = (TMP_64 = function($d_rest){var self = TMP_64.$$s || this, value, $e;
        ...
        if ((($e = $scope.get('Opal').$destructure(value)) !== nil && (!$e.$$is_boolean || $e == true))) {
            ...
            return nil
          }}, TMP_64.$$s = self, TMP_64.$$brk = $brk, TMP_64.$$arity = -1, TMP_64), $a).call($c)
        } catch (err) { if (err === $brk) { return err.$v } else { throw err } }})()
      };
      return result;
    }, TMP_62.$$arity = 0);

    Opal.defn(self, '$partition', TMP_65 = function ːpartition() {
      var $a, $b, TMP_66, self = this, $iter = TMP_65.$$p, block = $iter || nil;

      TMP_65.$$p = null;
      if ((block !== nil)) {
        } else {
        return ($a = ($b = self).$enum_for, $a.$$p = (TMP_66 = function(){var self = TMP_66.$$s || this;

        return self.$enumerator_size()}, TMP_66.$$s = self, TMP_66.$$arity = 0, TMP_66), $a).call($b, "partition")
      };
    ...
    Opal.defn(self, '$reject', TMP_67 = function ːreject() {
      var $a, $b, TMP_68, self = this, $iter = TMP_67.$$p, block = $iter || nil;

      TMP_67.$$p = null;
      if ((block !== nil)) {
        } else {
        return ($a = ($b = self).$enum_for, $a.$$p = (TMP_68 = function(){var self = TMP_68.$$s || this;

        return self.$enumerator_size()}, TMP_68.$$s = self, TMP_68.$$arity = 0, TMP_68), $a).call($b, "reject")
      };
    ...
    Opal.defn(self, '$reverse_each', TMP_69 = function ːreverse_each() {
      var $a, $b, TMP_70, self = this, $iter = TMP_69.$$p, block = $iter || nil;

      TMP_69.$$p = null;
      if ((block !== nil)) {
        } else {
        return ($a = ($b = self).$enum_for, $a.$$p = (TMP_70 = function(){var self = TMP_70.$$s || this;

        return self.$enumerator_size()}, TMP_70.$$s = self, TMP_70.$$arity = 0, TMP_70), $a).call($b, "reverse_each")
      };
    ...
    Opal.defn(self, '$slice_before', TMP_71 = function ːslice_before(pattern) {
      var $a, $b, TMP_72, self = this, $iter = TMP_71.$$p, block = $iter || nil;

      TMP_71.$$p = null;
      if ((($a = pattern === undefined && block === nil || arguments.length > 1) !== nil && (!$a.$$is_boolean || $a == true))) {
        self.$raise($scope.get('ArgumentError'), "wrong number of arguments (" + (arguments.length) + " for 1)")};
      return ($a = ($b = $scope.get('Enumerator')).$new, $a.$$p = (TMP_72 = function(e){var self = TMP_72.$$s || this, $c;
if (e == null) e = nil;
        ...
        if (block !== nil) {
          if (pattern === undefined) {
            self.$each.$$p = function() {
              ...
              if ((($c = value) !== nil && (!$c.$$is_boolean || $c == true)) && slice.length > 0) {
                e['$<<'](slice);
                slice = [];
              }
      ...
      ;}, TMP_72.$$s = self, TMP_72.$$arity = 1, TMP_72), $a).call($b);
    }, TMP_71.$$arity = -1);

    Opal.defn(self, '$sort', TMP_73 = function ːsort() {
      var $a, $b, TMP_74, $c, self = this, $iter = TMP_73.$$p, block = $iter || nil, ary = nil;

      TMP_73.$$p = null;
      ary = self.$to_a();
      if ((block !== nil)) {
        } else {
        block = ($a = ($b = self).$lambda, $a.$$p = (TMP_74 = function(a, b){var self = TMP_74.$$s || this;
if (a == null) a = nil;if (b == null) b = nil;
        return a['$<=>'](b)}, TMP_74.$$s = self, TMP_74.$$arity = 2, TMP_74), $a).call($b)
      };
      return ($a = ($c = ary).$sort, $a.$$p = block.$to_proc(), $a).call($c);
    }, TMP_73.$$arity = 0);

    Opal.defn(self, '$sort_by', TMP_75 = function ːsort_by() {
      var $a, $b, TMP_76, $c, TMP_77, $d, TMP_78, $e, TMP_79, self = this, $iter = TMP_75.$$p, block = $iter || nil, dup = nil;
      ...
      if ((block !== nil)) {
        ...
        return self.$enumerator_size()}, TMP_76.$$s = self, TMP_76.$$arity = 0, TMP_76), $a).call($b, "sort_by")
      };
      dup = ($a = ($c = self).$map, $a.$$p = (TMP_77 = function(){var self = TMP_77.$$s || this, $yielded, arg = nil;

      arg = $scope.get('Opal').$destructure(arguments);
        ($yielded = Opal.yield1(block, arg));return [$yielded, arg];}, TMP_77.$$s = self, TMP_77.$$arity = 0, TMP_77), $a).call($c);
      ($a = ($d = dup)['$sort!'], $a.$$p = (TMP_78 = function(a, b){var self = TMP_78.$$s || this;
if (a == null) a = nil;if (b == null) b = nil;
      return (a[0])['$<=>'](b[0])}, TMP_78.$$s = self, TMP_78.$$arity = 2, TMP_78), $a).call($d);
      return ($a = ($e = dup)['$map!'], $a.$$p = (TMP_79 = function(i){var self = TMP_79.$$s || this;
if (i == null) i = nil;
      return i[1];}, TMP_79.$$s = self, TMP_79.$$arity = 1, TMP_79), $a).call($e);
    }, TMP_75.$$arity = 0);

    Opal.defn(self, '$take', TMP_80 = function ːtake(num) {
      var self = this;

      return self.$first(num);
    }, TMP_80.$$arity = 1);

    Opal.defn(self, '$take_while', TMP_81 = function ːtake_while() {
      var $a, $b, TMP_82, self = this, $iter = TMP_81.$$p, block = $iter || nil, result = nil;
      ...
      result = [];
      (function(){var $brk = Opal.new_brk(); try {return ($a = ($b = self).$each, $a.$$p = (TMP_82 = function($c_rest){var self = TMP_82.$$s || this, args, $d, value = nil;
      ...
      value = $scope.get('Opal').$destructure(args);
        ...
        return result.push(value);}, TMP_82.$$s = self, TMP_82.$$brk = $brk, TMP_82.$$arity = -1, TMP_82), $a).call($b)
      } catch (err) { if (err === $brk) { return err.$v } else { throw err } }})();
      return result;
    }, TMP_81.$$arity = 0);
    ...
    Opal.defn(self, '$zip', TMP_83 = function ːzip($a_rest) {
      var $b, self = this, others, $iter = TMP_83.$$p, block = $iter || nil;
  ...
  return (function($base, $super) {
    ...
    Opal.defn(self, '$initialize', TMP_2 = function ːinitialize($a_rest) {
      ...
      if (block !== false && block !== nil) {
        ...
        if ((($b = self.size) !== nil && (!$b.$$is_boolean || $b == true))) {
    ...
    Opal.defn(self, '$each', TMP_3 = function ːeach($a_rest) {
      ...
      TMP_3.$$p = null;
      if ((($b = ($c = block['$nil?'](), $c !== false && $c !== nil ?args['$empty?']() : $c)) !== nil && (!$b.$$is_boolean || $b == true))) {
        return self};
      args = $rb_plus(self.args, args);
      if ((($b = block['$nil?']()) !== nil && (!$b.$$is_boolean || $b == true))) {
...
if (v == null) v = nil;
      ...
      Opal.defn(self, '$drop', TMP_24 = function ːdrop(n) {
        ...
        if ((($d = $rb_lt(dropped, n)) !== nil && (!$d.$$is_boolean || $d == true))) {
      ...
      Opal.defn(self, '$drop_while', TMP_25 = function ːdrop_while() {
        ...
        if (succeeding !== false && succeeding !== nil) {
            ...
            if ((($d = value) === nil || ($d.$$is_boolean && $d == false))) {
              succeeding = false;
      ...
      Opal.defn(self, '$find_all', TMP_28 = function ːfind_all() {
        ...
        return ($a = ($b = $scope.get('Lazy')).$new, $a.$$p = (TMP_29 = function(enum$, $c_rest){var self = TMP_29.$$s || this, args, $d;
          ...
          if ((($d = value) !== nil && (!$d.$$is_boolean || $d == true))) {
            ($d = enum$).$yield.apply($d, Opal.to_a(args));
          }
      ...
      Opal.defn(self, '$grep', TMP_30 = function ːgrep(pattern) {
        ...
        if (block !== false && block !== nil) {
          ...
          return ($a = ($c = $scope.get('Lazy')).$new, $a.$$p = (TMP_32 = function(enum$, $d_rest){var self = TMP_32.$$s || this, args, $e;
            ...
            if ((($e = value) !== nil && (!$e.$$is_boolean || $e == true))) {
              enum$.$yield(param);
            }
      ...
      Opal.defn(self, '$take', TMP_36 = function ːtake(n) {
        ...
        if ((($d = $rb_lt(taken, n)) !== nil && (!$d.$$is_boolean || $d == true))) {
            ($d = enum$).$yield.apply($d, Opal.to_a(args));
...
Opal.modules["corelib/array"] = function(Opal) {
  ...
  return (function($base, $super) {
    ...
    var def = self.$$proto, $scope = self.$$scope, TMP_1, TMP_2, TMP_3, TMP_4, TMP_5, TMP_6, TMP_7, TMP_8, TMP_9, TMP_10, TMP_11, TMP_12, TMP_13, TMP_14, TMP_15, TMP_16, TMP_17, TMP_19, TMP_20, TMP_21, TMP_23, TMP_25, TMP_27, TMP_29, TMP_30, TMP_31, TMP_32, TMP_33, TMP_34, TMP_36, TMP_37, TMP_39, TMP_41, TMP_42, TMP_43, TMP_44, TMP_45, TMP_46, TMP_47, TMP_48, TMP_49, TMP_50, TMP_51, TMP_52, TMP_53, TMP_54, TMP_56, TMP_57, TMP_58, TMP_60, TMP_62, TMP_63, TMP_64, TMP_65, TMP_66, TMP_68, TMP_70, TMP_71, TMP_72, TMP_73, TMP_75, TMP_76, TMP_77, TMP_80, TMP_81, TMP_83, TMP_85, TMP_86, TMP_87, TMP_88, TMP_89, TMP_90, TMP_91, TMP_93, TMP_94, TMP_95, TMP_96, TMP_99, TMP_100, TMP_101, TMP_102, TMP_105, TMP_106, TMP_107, TMP_109;
    ...
    Opal.defn(self, '$initialize_copy', TMP_20 = function ːinitialize_copy(other) {
      var self = this;

      return self.$replace(other);
    }, TMP_20.$$arity = 1);

    Opal.defn(self, '$collect', TMP_21 = function ːcollect() {
      ...
      if ((block !== nil)) {
        ...
        return self.$size()}, TMP_22.$$s = self, TMP_22.$$arity = 0, TMP_22), $a).call($b, "collect")
      };
    ...
    Opal.defn(self, '$collect!', TMP_23 = function() {
      ...
      if ((block !== nil)) {
        ...
        return self.$size()}, TMP_24.$$s = self, TMP_24.$$arity = 0, TMP_24), $a).call($b, "collect!")
      };
    ...
    Opal.defn(self, '$combination', TMP_25 = function ːcombination(n) {
      var $a, $b, TMP_26, self = this, $iter = TMP_25.$$p, $yield = $iter || nil, num = nil;
      ...
      if (($yield !== nil)) {
        ...
        return binomial_coefficient(self.length, num);}, TMP_26.$$s = self, TMP_26.$$arity = 0, TMP_26), $a).call($b, "combination", num)
      };
    ...
    Opal.defn(self, '$repeated_combination', TMP_27 = function ːrepeated_combination(n) {
      var $a, $b, TMP_28, self = this, $iter = TMP_27.$$p, $yield = $iter || nil, num = nil;
      ...
      if (($yield !== nil)) {
        ...
        return binomial_coefficient(self.length + num - 1, num);}, TMP_28.$$s = self, TMP_28.$$arity = 0, TMP_28), $a).call($b, "repeated_combination", num)
      };
    ...
    Opal.defn(self, '$compact', TMP_29 = function ːcompact() {
      var self = this;
    ...
    Opal.defn(self, '$compact!', TMP_30 = function() {
      var self = this;
    ...
    Opal.defn(self, '$concat', TMP_31 = function ːconcat(other) {
      var $a, self = this;
    ...
    Opal.defn(self, '$delete', TMP_32 = function(object) {
      var self = this, $iter = TMP_32.$$p, $yield = $iter || nil;
    ...
    Opal.defn(self, '$delete_at', TMP_33 = function ːdelete_at(index) {
      var self = this;
    ...
    Opal.defn(self, '$delete_if', TMP_34 = function ːdelete_if() {
      ...
      if ((block !== nil)) {
        ...
        return self.$size()}, TMP_35.$$s = self, TMP_35.$$arity = 0, TMP_35), $a).call($b, "delete_if")
      };
    ...
    Opal.defn(self, '$drop', TMP_36 = function ːdrop(number) {
      var self = this;
    ...
    Opal.defn(self, '$each', TMP_37 = function ːeach() {
      ...
      if ((block !== nil)) {
        ...
        return self.$size()}, TMP_38.$$s = self, TMP_38.$$arity = 0, TMP_38), $a).call($b, "each")
      };
    ...
    Opal.defn(self, '$each_index', TMP_39 = function ːeach_index() {
      ...
      if ((block !== nil)) {
        ...
        return self.$size()}, TMP_40.$$s = self, TMP_40.$$arity = 0, TMP_40), $a).call($b, "each_index")
      };
    ...
    Opal.defn(self, '$empty?', TMP_41 = function() {
      var self = this;

      return self.length === 0;
    }, TMP_41.$$arity = 0);

    Opal.defn(self, '$eql?', TMP_42 = function(other) {
      var self = this;
    ...
    Opal.defn(self, '$fetch', TMP_43 = function ːfetch(index, defaults) {
    ...
    Opal.defn(self, '$fill', TMP_44 = function ːfill($a_rest) {
      var $b, $c, self = this, args, $iter = TMP_44.$$p, block = $iter || nil, one = nil, two = nil, obj = nil, left = nil, right = nil;
      ...
      if (block !== false && block !== nil) {
        if ((($b = args.length > 2) !== nil && (!$b.$$is_boolean || $b == true))) {
        ...
        if ((($b = args.length == 0) !== nil && (!$b.$$is_boolean || $b == true))) {
          self.$raise($scope.get('ArgumentError'), "wrong number of arguments (0 for 1..3)")
        } else if ((($b = args.length > 3) !== nil && (!$b.$$is_boolean || $b == true))) {
      ...
      if ((($b = $scope.get('Range')['$==='](one)) !== nil && (!$b.$$is_boolean || $b == true))) {
        ...
        if ((($b = left < 0) !== nil && (!$b.$$is_boolean || $b == true))) {
          left += self.length;};
        if ((($b = left < 0) !== nil && (!$b.$$is_boolean || $b == true))) {
          self.$raise($scope.get('RangeError'), "" + (one.$inspect()) + " out of range")};
        right = $scope.get('Opal').$coerce_to(one.$end(), $scope.get('Integer'), "to_int");
        if ((($b = right < 0) !== nil && (!$b.$$is_boolean || $b == true))) {
          right += self.length;};
        if ((($b = one['$exclude_end?']()) !== nil && (!$b.$$is_boolean || $b == true))) {
          } else {
          right += 1;
        };
        if ((($b = right <= left) !== nil && (!$b.$$is_boolean || $b == true))) {
          return self};
      ...
      if ((($b = left > self.length) !== nil && (!$b.$$is_boolean || $b == true))) {

        for (i = self.length; i < right; i++) {
          self[i] = nil;
        }
      ;};
      if ((($b = right > self.length) !== nil && (!$b.$$is_boolean || $b == true))) {
        self.length = right};
      if (block !== false && block !== nil) {
    ...
    Opal.defn(self, '$first', TMP_45 = function ːfirst(count) {
      var self = this;
    ...
    Opal.defn(self, '$flatten', TMP_46 = function ːflatten(level) {
      var self = this;
    ...
    Opal.defn(self, '$flatten!', TMP_47 = function(level) {
      var self = this;
    ...
    Opal.defn(self, '$hash', TMP_48 = function ːhash() {
      var self = this;
    ...
    Opal.defn(self, '$include?', TMP_49 = function(member) {
      var self = this;
    ...
    Opal.defn(self, '$index', TMP_50 = function ːindex(object) {
      var self = this, $iter = TMP_50.$$p, block = $iter || nil;
    ...
    Opal.defn(self, '$insert', TMP_51 = function ːinsert(index, $a_rest) {
      var self = this, objects;
    ...
    Opal.defn(self, '$inspect', TMP_52 = function ːinspect() {
      var self = this;
    ...
    Opal.defn(self, '$join', TMP_53 = function ːjoin(sep) {
      var $a, self = this;
      if ($gvars[","] == null) $gvars[","] = nil;
    ...
    Opal.defn(self, '$keep_if', TMP_54 = function ːkeep_if() {
      var $a, $b, TMP_55, self = this, $iter = TMP_54.$$p, block = $iter || nil;
      ...
      if ((block !== nil)) {
        ...
        return self.$size()}, TMP_55.$$s = self, TMP_55.$$arity = 0, TMP_55), $a).call($b, "keep_if")
      };
    ...
    Opal.defn(self, '$last', TMP_56 = function ːlast(count) {
      var self = this;
    ...
    Opal.defn(self, '$length', TMP_57 = function ːlength() {
      var self = this;
    ...
    Opal.defn(self, '$permutation', TMP_58 = function ːpermutation(num) {
      var $a, $b, TMP_59, self = this, $iter = TMP_58.$$p, block = $iter || nil, perm = nil, used = nil;

      TMP_58.$$p = null;
      if ((block !== nil)) {
        } else {
        return ($a = ($b = self).$enum_for, $a.$$p = (TMP_59 = function(){var self = TMP_59.$$s || this;

        return descending_factorial(self.length, num === undefined ? self.length : num);}, TMP_59.$$s = self, TMP_59.$$arity = 0, TMP_59), $a).call($b, "permutation", num)
      };
    ...
    Opal.defn(self, '$repeated_permutation', TMP_60 = function ːrepeated_permutation(n) {
      var $a, $b, TMP_61, self = this, $iter = TMP_60.$$p, $yield = $iter || nil, num = nil;

      TMP_60.$$p = null;
      num = $scope.get('Opal')['$coerce_to!'](n, $scope.get('Integer'), "to_int");
      if (($yield !== nil)) {
        } else {
        return ($a = ($b = self).$enum_for, $a.$$p = (TMP_61 = function(){var self = TMP_61.$$s || this, $c;

        if ((($c = $rb_ge(num, 0)) !== nil && (!$c.$$is_boolean || $c == true))) {
            return self.$size()['$**'](num)
            } else {
            return 0
          }}, TMP_61.$$s = self, TMP_61.$$arity = 0, TMP_61), $a).call($b, "repeated_permutation", num)
      };
    ...
    Opal.defn(self, '$pop', TMP_62 = function ːpop(count) {
      var $a, self = this;
    ...
    Opal.defn(self, '$product', TMP_63 = function ːproduct($a_rest) {
      var self = this, args, $iter = TMP_63.$$p, block = $iter || nil;
    ...
    Opal.defn(self, '$push', TMP_64 = function ːpush($a_rest) {
      var self = this, objects;
    ...
    Opal.defn(self, '$rassoc', TMP_65 = function ːrassoc(object) {
      var self = this;
    ...
    Opal.defn(self, '$reject', TMP_66 = function ːreject() {
      var $a, $b, TMP_67, self = this, $iter = TMP_66.$$p, block = $iter || nil;

      TMP_66.$$p = null;
      if ((block !== nil)) {
        } else {
        return ($a = ($b = self).$enum_for, $a.$$p = (TMP_67 = function(){var self = TMP_67.$$s || this;

        return self.$size()}, TMP_67.$$s = self, TMP_67.$$arity = 0, TMP_67), $a).call($b, "reject")
      };
    ...
    Opal.defn(self, '$reject!', TMP_68 = function() {
      var $a, $b, TMP_69, $c, self = this, $iter = TMP_68.$$p, block = $iter || nil, original = nil;
    ...
    Opal.defn(self, '$replace', TMP_70 = function ːreplace(other) {
      var $a, self = this;
    ...
    Opal.defn(self, '$reverse', TMP_71 = function ːreverse() {
      var self = this;

      return self.slice(0).reverse();
    }, TMP_71.$$arity = 0);

    Opal.defn(self, '$reverse!', TMP_72 = function() {
      var self = this;

      return self.reverse();
    }, TMP_72.$$arity = 0);

    Opal.defn(self, '$reverse_each', TMP_73 = function ːreverse_each() {
      var $a, $b, TMP_74, $c, self = this, $iter = TMP_73.$$p, block = $iter || nil;

      TMP_73.$$p = null;
      if ((block !== nil)) {
        } else {
        return ($a = ($b = self).$enum_for, $a.$$p = (TMP_74 = function(){var self = TMP_74.$$s || this;

        return self.$size()}, TMP_74.$$s = self, TMP_74.$$arity = 0, TMP_74), $a).call($b, "reverse_each")
      };
      ($a = ($c = self.$reverse()).$each, $a.$$p = block.$to_proc(), $a).call($c);
      return self;
    }, TMP_73.$$arity = 0);

    Opal.defn(self, '$rindex', TMP_75 = function ːrindex(object) {
      var self = this, $iter = TMP_75.$$p, block = $iter || nil;
    ...
    Opal.defn(self, '$rotate', TMP_76 = function ːrotate(n) {
      var self = this;
    ...
    Opal.defn(self, '$rotate!', TMP_77 = function(cnt) {
    ...
    (function($base, $super) {
      ...
      var def = self.$$proto, $scope = self.$$scope, TMP_78, TMP_79;

      def.rng = nil;
      Opal.defn(self, '$initialize', TMP_78 = function ːinitialize(rng) {
        var self = this;

        return self.rng = rng;
      }, TMP_78.$$arity = 1);

      return (Opal.defn(self, '$rand', TMP_79 = function ːrand(size) {
        ...
        return random;
      }, TMP_79.$$arity = 1), nil) && 'rand';
    })($scope.base, null);

    Opal.defn(self, '$sample', TMP_80 = function ːsample(count, options) {
    ...
    Opal.defn(self, '$select', TMP_81 = function ːselect() {
      var $a, $b, TMP_82, self = this, $iter = TMP_81.$$p, block = $iter || nil;

      TMP_81.$$p = null;
      if ((block !== nil)) {
        } else {
        return ($a = ($b = self).$enum_for, $a.$$p = (TMP_82 = function(){var self = TMP_82.$$s || this;

        return self.$size()}, TMP_82.$$s = self, TMP_82.$$arity = 0, TMP_82), $a).call($b, "select")
      };
    ...
    Opal.defn(self, '$select!', TMP_83 = function() {
      var $a, $b, TMP_84, $c, self = this, $iter = TMP_83.$$p, block = $iter || nil;
    ...
    Opal.defn(self, '$shift', TMP_85 = function ːshift(count) {
      var $a, self = this;
    ...
    Opal.defn(self, '$shuffle', TMP_86 = function ːshuffle(rng) {
      var self = this;

      return self.$dup().$to_a()['$shuffle!'](rng);
    }, TMP_86.$$arity = -1);

    Opal.defn(self, '$shuffle!', TMP_87 = function(rng) {
      var self = this;
    ...
    Opal.defn(self, '$slice!', TMP_88 = function(index, length) {
      var $a, self = this, result = nil, range = nil, range_start = nil, range_end = nil, start = nil;

      result = nil;
      if ((($a = length === undefined) !== nil && (!$a.$$is_boolean || $a == true))) {
        if ((($a = $scope.get('Range')['$==='](index)) !== nil && (!$a.$$is_boolean || $a == true))) {
          range = index;
          result = self['$[]'](range);
    ...
    Opal.defn(self, '$sort', TMP_89 = function ːsort() {
      var $a, self = this, $iter = TMP_89.$$p, block = $iter || nil;
    ...
    Opal.defn(self, '$sort!', TMP_90 = function() {
      var $a, $b, self = this, $iter = TMP_90.$$p, block = $iter || nil;
    ...
    Opal.defn(self, '$sort_by!', TMP_91 = function() {
      var $a, $b, TMP_92, $c, self = this, $iter = TMP_91.$$p, block = $iter || nil;

      TMP_91.$$p = null;
      if ((block !== nil)) {
        } else {
        return ($a = ($b = self).$enum_for, $a.$$p = (TMP_92 = function(){var self = TMP_92.$$s || this;

        return self.$size()}, TMP_92.$$s = self, TMP_92.$$arity = 0, TMP_92), $a).call($b, "sort_by!")
      };
      return self.$replace(($a = ($c = self).$sort_by, $a.$$p = block.$to_proc(), $a).call($c));
    }, TMP_91.$$arity = 0);

    Opal.defn(self, '$take', TMP_93 = function ːtake(count) {
      var self = this;
    ...
    Opal.defn(self, '$take_while', TMP_94 = function ːtake_while() {
      var self = this, $iter = TMP_94.$$p, block = $iter || nil;
    ...
    Opal.defn(self, '$to_a', TMP_95 = function ːto_a() {
      var self = this;
    ...
    Opal.defn(self, '$to_h', TMP_96 = function ːto_h() {
      var self = this;
    ...
    Opal.defn(self, '$transpose', TMP_99 = function ːtranspose() {
      var $a, $b, TMP_97, self = this, result = nil, max = nil;

      if ((($a = self['$empty?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
        return []};
      result = [];
      max = nil;
      ($a = ($b = self).$each, $a.$$p = (TMP_97 = function(row){var self = TMP_97.$$s || this, $c, $d, TMP_98;
if (row == null) row = nil;
      if ((($c = $scope.get('Array')['$==='](row)) !== nil && (!$c.$$is_boolean || $c == true))) {
          row = row.$to_a()
          } else {
          row = $scope.get('Opal').$coerce_to(row, $scope.get('Array'), "to_ary").$to_a()
        };
        ((($c = max) !== false && $c !== nil) ? $c : max = row.length);
        if ((($c = (row.length)['$!='](max)) !== nil && (!$c.$$is_boolean || $c == true))) {
          self.$raise($scope.get('IndexError'), "element size differs (" + (row.length) + " should be " + (max))};
        return ($c = ($d = (row.length)).$times, $c.$$p = (TMP_98 = function(i){var self = TMP_98.$$s || this, $e, $f, $g, entry = nil;
if (i == null) i = nil;
        entry = (($e = i, $f = result, ((($g = $f['$[]']($e)) !== false && $g !== nil) ? $g : $f['$[]=']($e, []))));
          return entry['$<<'](row.$at(i));}, TMP_98.$$s = self, TMP_98.$$arity = 1, TMP_98), $c).call($d);}, TMP_97.$$s = self, TMP_97.$$arity = 1, TMP_97), $a).call($b);
      return result;
    }, TMP_99.$$arity = 0);

    Opal.defn(self, '$uniq', TMP_100 = function ːuniq() {
      var self = this, $iter = TMP_100.$$p, block = $iter || nil;
    ...
    Opal.defn(self, '$uniq!', TMP_101 = function() {
      var self = this, $iter = TMP_101.$$p, block = $iter || nil;
    ...
    Opal.defn(self, '$unshift', TMP_102 = function ːunshift($a_rest) {
      var self = this, objects;
    ...
    Opal.defn(self, '$values_at', TMP_105 = function ːvalues_at($a_rest) {
      var $b, $c, TMP_103, self = this, args, out = nil;
      ...
      out = [];
      ($b = ($c = args).$each, $b.$$p = (TMP_103 = function(elem){var self = TMP_103.$$s || this, $a, $d, TMP_104, finish = nil, start = nil, i = nil;
if (elem == null) elem = nil;
      if ((($a = elem['$kind_of?']($scope.get('Range'))) !== nil && (!$a.$$is_boolean || $a == true))) {
          ...
          return ($a = ($d = start).$upto, $a.$$p = (TMP_104 = function(i){var self = TMP_104.$$s || this;
if (i == null) i = nil;
          return out['$<<'](self.$at(i))}, TMP_104.$$s = self, TMP_104.$$arity = 1, TMP_104), $a).call($d, finish);
          } else {
          i = $scope.get('Opal').$coerce_to(elem, $scope.get('Integer'), "to_int");
          return out['$<<'](self.$at(i));
        }}, TMP_103.$$s = self, TMP_103.$$arity = 1, TMP_103), $b).call($c);
      return out;
    }, TMP_105.$$arity = -1);

    Opal.defn(self, '$zip', TMP_106 = function ːzip($a_rest) {
      var $b, self = this, others, $iter = TMP_106.$$p, block = $iter || nil;
      ...
      for (j = 0, jj = others.length; j < jj; j++) {
        ...
        others[j] = (((($b = $scope.get('Opal')['$coerce_to?'](o, $scope.get('Array'), "to_ary")) !== false && $b !== nil) ? $b : $scope.get('Opal')['$coerce_to!'](o, $scope.get('Enumerator'), "each"))).$to_a();
      }
    ...
    Opal.defs(self, '$inherited', TMP_107 = function ːinherited(klass) {
      var self = this;
    ...
    return (Opal.defn(self, '$instance_variables', TMP_109 = function ːinstance_variables() {
      var $a, $b, TMP_108, $c, $d, self = this, $iter = TMP_109.$$p, $yield = $iter || nil, $zuper = nil, $zuper_index = nil, $zuper_length = nil;
      ...
      return ($a = ($b = ($c = ($d = self, Opal.find_super_dispatcher(self, 'instance_variables', TMP_109, false)), $c.$$p = $iter, $c).apply($d, $zuper)).$reject, $a.$$p = (TMP_108 = function(ivar){var self = TMP_108.$$s || this, $c;
if (ivar == null) ivar = nil;
      return ((($c = /^@\d+$/.test(ivar)) !== false && $c !== nil) ? $c : ivar['$==']("@length"))}, TMP_108.$$s = self, TMP_108.$$arity = 1, TMP_108), $a).call($b);
    }, TMP_109.$$arity = 0), nil) && 'instance_variables';
  })($scope.base, Array);
};
  ...
  (function($base, $super) {
    ...
    Opal.defn(self, '$downto', TMP_31 = function ːdownto(stop) {
      ...
      if ((block !== nil)) {
        ...
        if ((($c = $scope.get('Numeric')['$==='](stop)) !== nil && (!$c.$$is_boolean || $c == true))) {
            } else {
            self.$raise($scope.get('ArgumentError'), "comparison of " + (self.$class()) + " with " + (stop.$class()) + " failed")
          };
          if ((($c = $rb_gt(stop, self)) !== nil && (!$c.$$is_boolean || $c == true))) {
            return 0
            } else {
    ...
    Opal.defn(self, '$upto', TMP_59 = function ːupto(stop) {
      ...
      if ((block !== nil)) {
        ...
        if ((($c = $scope.get('Numeric')['$==='](stop)) !== nil && (!$c.$$is_boolean || $c == true))) {
          ...
          if ((($c = $rb_lt(stop, self)) !== nil && (!$c.$$is_boolean || $c == true))) {
            return 0
            } else {
...
Opal.modules["corelib/string/inheritance"] = function(Opal) {
  ...
  return (function($base, $super) {
    ...
    Opal.defn(self, '$method_missing', TMP_6 = function ːmethod_missing($a_rest) {
      ...
      if ((($b = result.$$is_string != null) !== nil && (!$b.$$is_boolean || $b == true))) {
    ...
    Opal.defn(self, '$respond_to?', TMP_8 = function(name, $a_rest) {
      ...
      return ((($b = ($c = ($d = self, Opal.find_super_dispatcher(self, 'respond_to?', TMP_8, false)), $c.$$p = $iter, $c).apply($d, $zuper)) !== false && $b !== nil) ? $b : self.literal['$respond_to?'](name));
    }, TMP_8.$$arity = -2);
...
if (const$ == null) const$ = nil;
      encoding = self.$const_get(const$);
        if ((($c = $scope.get('Encoding')['$==='](encoding)) !== nil && (!$c.$$is_boolean || $c == true))) {
          } else {
          return nil;
        };
        if ((($c = ((($d = encoding.$name()['$=='](upcase)) !== false && $d !== nil) ? $d : encoding.$names()['$include?'](upcase))) !== nil && (!$c.$$is_boolean || $c == true))) {
          Opal.ret(encoding)
          } else {
          return nil
...
Opal.modules["corelib/struct"] = function(Opal) {
  ...
  return (function($base, $super) {
    ...
    Opal.defs(self, '$new', TMP_1 = function(const_name, $a_rest) {
      ...
      TMP_1.$$p = null;
      if (const_name !== false && const_name !== nil) {
        try {
...
if (value == null) value = nil;
    ...
    Opal.defn(self, '$initialize', TMP_13 = function ːinitialize($a_rest) {
      ...
      if ((($b = $rb_gt(args.$length(), self.$class().$members().$length())) !== nil && (!$b.$$is_boolean || $b == true))) {
...
if (name == null) name = nil;if (index == null) index = nil;
    ...
    Opal.defn(self, '$[]', TMP_16 = function(name) {
      ...
      if ((($a = $scope.get('Integer')['$==='](name)) !== nil && (!$a.$$is_boolean || $a == true))) {
        if ((($a = $rb_lt(name, self.$class().$members().$size()['$-@']())) !== nil && (!$a.$$is_boolean || $a == true))) {
          self.$raise($scope.get('IndexError'), "offset " + (name) + " too small for struct(size:" + (self.$class().$members().$size()) + ")")};
        if ((($a = $rb_ge(name, self.$class().$members().$size())) !== nil && (!$a.$$is_boolean || $a == true))) {
    ...
    Opal.defn(self, '$[]=', TMP_17 = function(name, value) {
      ...
      if ((($a = $scope.get('Integer')['$==='](name)) !== nil && (!$a.$$is_boolean || $a == true))) {
        ...
        if ((($a = self.$class().$members()['$include?'](name.$to_sym())) !== nil && (!$a.$$is_boolean || $a == true))) {
          } else {
          self.$raise($scope.get('NameError').$new("no member '" + (name) + "' in struct", name))
        }
        } else {
...
if (name == null) name = nil;
    ...
    Opal.defn(self, '$inspect', TMP_30 = function ːinspect() {
      ...
      result = "#<struct ";
      if ((($a = ($b = $scope.get('Struct')['$==='](self), $b !== false && $b !== nil ?self.$class().$name() : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
...
if (part == null) part = nil;
      ...
      Opal.defn(self, '$extname', TMP_5 = function ːextname(path) {
        ...
        if ((($a = path['$nil?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
          self.$raise($scope.get('TypeError'), "no implicit conversion of nil into String")};
        if ((($a = path['$respond_to?']("to_path")) !== nil && (!$a.$$is_boolean || $a == true))) {
          path = path.$to_path()};
        if ((($a = path['$is_a?']($scope.get('String'))) !== nil && (!$a.$$is_boolean || $a == true))) {
          } else {
          self.$raise($scope.get('TypeError'), "no implicit conversion of " + (path.$class()) + " into String")
        };
        filename = self.$basename(path);
        if ((($a = filename['$empty?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
          return ""};
        last_dot_idx = filename['$[]']($range(1, -1, false)).$rindex(".");
        if ((($a = (((($b = last_dot_idx['$nil?']()) !== false && $b !== nil) ? $b : $rb_plus(last_dot_idx, 1)['$==']($rb_minus(filename.$length(), 1))))) !== nil && (!$a.$$is_boolean || $a == true))) {
          return ""
          } else {
