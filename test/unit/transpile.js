...
describe('transpile', function(){
  ...
  it('passes custom configured Opal runtime through', function() {
    useTweakedCompiler()
  ...
  describe('webpack requires', function() {
    ...
    context('for compiler js file', function () {
      context('using bundled redirects requires for', function() {
        it('opal', function() {
          ...
          expect(result).to.match(/require\('!!the_loader_path\?file=opal&requirable=false!.*\/vendor\/opal-runtime.js'\);/)
        })
        it('opal/full', function() {
          var result = doTranspile('require "opal/full"')

          expect(result).to.match(/require\('!!the_loader_path\?file=opal%2Ffull&requirable=false!.*\/vendor\/opal-runtime.js'\);/)
        })
        it('opal/mini', function() {
          var result = doTranspile('require "opal/mini"')

          expect(result).to.match(/require\('!!the_loader_path\?file=opal%2Fmini&requirable=false!.*\/vendor\/opal-runtime.js'\);/)
        })
      })
      ...
      context('using custom file redirects requires for', function() {
        it('opal', function() {
          ...
          expect(result).to.match(/require\('!!the_loader_path\?file=opal&requirable=false!.*tweakedOpalRuntime.js'\);/)
        })
        it('opal/full', function() {
          var result = runOpalRequireTest('require "opal/full"')

          expect(result).to.match(/require\('!!the_loader_path\?file=opal%2Ffull&requirable=false!.*tweakedOpalRuntime.js'\);/)
        })
        it('opal/mini', function() {
          var result = runOpalRequireTest('require "opal/mini"')

          expect(result).to.match(/require\('!!the_loader_path\?file=opal%2Fmini&requirable=false!.*tweakedOpalRuntime.js'\);/)
        })
      })
    })
    ...
    it('require_tree', function() {
      ...
      expect(result).to.match(/require\('!!the_loader_path\?file=tree%2Ffile1&requirable=true!.*tree\/file1\.rb'\)/)
      expect(result).to.match(/require\('!!the_loader_path\?file=tree%2Ffile2&requirable=true!.*tree\/file2\.rb'\)/)
    })
  })
